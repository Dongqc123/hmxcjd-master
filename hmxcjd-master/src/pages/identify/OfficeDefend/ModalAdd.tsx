...
export default function ModalAdd(props) {
    ...
    return <Modal
        ...
        onOk={async () => {
            ...
            const ret = await request('/mx/xcjdwh/saveAddKsInfo', data);
            console.log(ret);
    ...
    >
        <div style={{ marginBottom: 10 }}>
            <Form form={form} {...formItemLayout}>
                <Form.Item label="科室编号" name="ksbh" rules={[{ required: true }]}>
                    <Input maxLength={30}
                    />
                </Form.Item>

                <Form.Item label="科室名称" name="ksmc" rules={[{ required: true }]}>
                    <Input maxLength={100}
                    />
                </Form.Item>

                <Form.Item label="所属医院" name="yybh" rules={[{ required: true }]}>
                    <Select >
                ...
                <Form.Item label="病种类别" name="bzlb" rules={[{ required: true }]}>
